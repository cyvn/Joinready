...
function ShapeBackground() {
  return (
    <>
      ...
      <div className="absolute inset-0 bg-gradient-to-t from-[#020617] via-transparent to-[#020617]/60 pointer-events-none" />
    </>
  );
}
      ...
      <div className="relative z-10 container mx-auto px-4 md:px-6">
        <div className="max-w-3xl mx-auto text-center">
          ...
          <motion.div custom={1} variants={fadeUpVariants} initial="hidden" animate="visible">
            <h1 className="text-4xl sm:text-6xl md:text-8xl font-display font-bold mb-6 md:mb-8 tracking-tight">
...
export { HeroGeometric, ShapeBackground };
